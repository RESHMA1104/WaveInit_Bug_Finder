...
Feature: Trainer Generates Course Structure via AI Prompt
              ...
              Trainers should be able to open the Course Editor for one of
  their courses and generate a course structure automatically by
  describing it in a prompt.
        ...
        Scenario Outline: Trainer generates a course structure from a prompt
             When the trainer opens the course editor for "<courseTitle>"
        ...
        Examples:
                  | courseTitle       | prompt                                                                                                                  |
                  | React Fundamental | Create a complete React course for beginners, from basics to advanced, for 1 month with 2 hours of learning every day.  |
                  | Python Fundamental| Create a complete Python course for beginners, from basics to advanced, for 1 month with 7 hours of learning every day. |